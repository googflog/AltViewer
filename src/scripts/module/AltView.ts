...
module AltViewModule {
  export class AltView extends events.EventDispatcher {
    ...
    Alt_List_txt1: string;
    Alt_List_txt2: string;
    Alt_List_txt3: string;
    Alt_List_txt4: string;
    Alt_List_txt5: string;
    Alt_List_txt6: string;
    Alt_List_txt7: string;
    ...
    show(): void {
      const getOptions_ = this.getOptions();

      getOptions_.then((values) => {
    ...
    addNoAltList(altlistbtn: boolean, alt_show: boolean, title_show: boolean, closebtn: boolean): void {
      ...
      if (0 < noCountVal) {
        //Alt無い画像があった場合
        $("html").prepend("<div id='AltView_NoAlt_Wrap' class='load'>" + "<div id='AltView_NoAlt_Result_Wrap'></div>" + "<a href='#' id='AltView_NoAlt_head_closeAltBtn'>" + "<img src='" + chrome.runtime.getURL("images/close_w.svg") + "' alt='CloseBtn' width='35'>" + "</a>" + "<a href='#' class='altViewNoAltHeadCloseBtn'>" + "<img class='arrow' src='" + chrome.runtime.getURL("images/arrow.svg") + "' alt='' width='35'>" + "<p class='altViewNoAltHeadCloseBtn__txt'>" + ListTabTxt + "<span>" + noCountVal + "</span>" + ListTabOrder + "</p></a>" + "</div>");
        ...
        //Alt完璧の場合
        $("html").prepend("<div id='AltView_NoAlt_Wrap' class='load'>" + "<div id='AltView_NoAlt_Result_Wrap'></div>" + "<a href='#' id='AltView_NoAlt_head_closeAltBtn'>" + "<img src='" + chrome.runtime.getURL("images/close_w.svg") + "' alt='CloseBtn' width='35'>" + "</a>" + "<a href='#' class='altViewNoAltHeadCloseBtn altViewNoAltHeadCloseBtn-perfect'>" + "<p class='altViewNoAltHeadCloseBtn__txt'>" + ListTabTxt + "</p></a>" + "</div>");
        $(".altViewNoAltHeadCloseBtn").on("click", function (e) {
          e.preventDefault();
      ...
      //にょっきり
      setTimeout(function () {
        $("#AltView_NoAlt_Wrap").removeClass("load");
      }, 500);
    ...
    addNoAltListObj(obj: any): JQuery {
      ...
      listobj.on("mouseover", function () {
        ...
        $("#AltView_wrap div.Tip")
          .not($("#alt_view_tip_" + obj.id))
          .hide();
    ...
    getImgTagData(index: number, element: JQuery): object {
      ...
      var width_attr: any = null;
      var height_attr: any = null;
